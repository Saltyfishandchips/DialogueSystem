...
public class DealWithMoney : MonoBehaviour, IPointerDownHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    void Start()
    {
        ...
        transferPanelRectTransform = GameObject.Find("BriberyPanel").GetComponent<RectTransform>();
    ...
    public void OnDrag(PointerEventData eventData)
    {
        ...
        {
            FlowDataManager.Instance.brieryNum++;
            //收钱
            Destroy(gameObject);
        }
    }
